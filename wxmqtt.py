...
mqttConnected=False  #global variable for the state of the mqtt connection
mqttBroker="192.168.1.1" # add the IP address of your MQTT broker her
mqttPort=1883
mqttUser="mqtt_user" # add the user name required to log into your MQTT broker (optional)
mqttPassword="mqtt_password"  # add the password required to log into your MQTT broker (optional)
...
#publish mqtt
# this is where you choose which attributes you want to publich via MQTT

        client.publish("wx/totalRain",str(totalRain))
        client.publish("wx/currentWindSpeed",str(currentWindSpeed))
        client.publish("wx/currentWindGust",str(currentWindGust))
        client.publish("wx/currentWindDirection",str(weatherStation.current_wind_direction()))
        client.publish("wx/currentWindDirectionVoltage",str(weatherStation.current_wind_direction_voltage()))
